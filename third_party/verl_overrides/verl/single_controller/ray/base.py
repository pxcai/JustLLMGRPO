...
def sort_placement_group_by_node_ip(pgs: list[PlacementGroup]) -> list[PlacementGroup]:
    ...
    for pg in pgs:
        try:
            ...
            # Ray 2.55 can hit protobuf runtime incompatibilities in
            # placement_group_table() on some environments. Keep the existing
            # order rather than failing; this is sufficient for single-node
            # smoke runs and only affects deterministic cross-node rank order.
            return pgs
