...
def get_hf_auto_model_class(hf_config):
    ...
    if has_remote_code:
        ...
        for key, cls in _architecture_to_auto_class.items():
            ...
            # Some transformers versions import optional VLM dependencies while
            # enumerating this mapping; keep text-only models from failing on
            # missing or incompatible optional packages.
            try:
