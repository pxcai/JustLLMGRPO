...
class DataProto:
    ...
    def from_tensordict(
        ...
        2. Only dim0 is the batch dim
        """
        assert version.parse(tensordict.__version__) >= version.parse("0.7.0"), (
            "Build DataProto from TensorDict at least requires tensordict version 0.7.0"
        )
    ...
    def to_tensordict(self) -> TensorDict:
        ...
        """
        assert parse_version(tensordict.__version__) >= parse_version("0.7"), (
            "Convert DataProto to TensorDict at least requires tensordict version 0.7"
        )
